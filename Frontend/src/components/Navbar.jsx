...
const Navbar = () => {
 ...
 useEffect(()=>{
  ...
  return (
    <>
      <div className={`max-w-screen-2xl container max-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${sticky ? "stickey=navbar shadow-md  bg-base-200 duration-300 transition-all ease-in-out" : ""}`}>
